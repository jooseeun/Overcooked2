...
public:
	...
	void Init(std::weak_ptr<InGameUIActor> _ParentActor_, std::function<void(int, int)> _HandOverFunction, std::function<void(int)> _FailFunction); //앞int : 음식 Score, 뒷 int : 팁 점수
